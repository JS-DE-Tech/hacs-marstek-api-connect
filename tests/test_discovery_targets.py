...
UDP_CLIENT_PATH = Path(__file__).parent.parent / "custom_components" / "hacs_marstek_api_connect" / "udp_client.py"
CONST_PATH = Path(__file__).parent.parent / "custom_components" / "hacs_marstek_api_connect" / "const.py"
...
load_module_from_file(
    "custom_components.hacs_marstek_api_connect.const",
    CONST_PATH,
)
UDP_CLIENT_MODULE = load_module_from_file(
    "custom_components.hacs_marstek_api_connect.udp_client",
    UDP_CLIENT_PATH,
)
