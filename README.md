...
2. This repository's integration folder to `/config/custom_components/hacs_marstek_api_connect`.
...
podman run -d \
  ...
  -v /path/to/this/repo/custom_components/hacs_marstek_api_connect:/config/custom_components/hacs_marstek_api_connect \
...
podman run -d `
  ...
  -v E:\Projets\hacs-marstek-api-connect\custom_components\hacs_marstek_api_connect:/config/custom_components/hacs_marstek_api_connect `
  homeassistant/home-assistant:stable
```
...
2. Copy or mount the integration into `custom_components/hacs_marstek_api_connect`.
